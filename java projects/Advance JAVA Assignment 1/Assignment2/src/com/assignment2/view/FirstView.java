...
//import com.assignment1.Controller.springControllerOne;
//import com.assignment1.view.springModuleView;
...
public class FirstView {
	 ...
	 * @param listenForbutton3 To set the background
	 */
	...
	public void startTheModule() {
		OptionPane theModuleView = new OptionPane();
		theModuleView.createGUI();
	//	springControllerOne theController2 = new springControllerOne(theModuleView);

	}

	/**
	 *  This is the listner class for button1
	 * @param listenForButton1 To start the game
	 */
	 ...
	 * @param listenForButton2 To close the game
	 */
	...
	/**
	 * This method is used for the "About" button which ihs displayed in the menu 
	 * It describes the game and the instructions which have to be followed to play the game
	 */
	public void aboutDialog()
	{
		String result="1. Accept the terms and conditions this will take you to the next view page where the simulation begins. \n"
			+	"2. When the game is running, the player must make sure that the car's do not collide.\n"
			+	"3. Every time a car collides with another there is a buffer period of 3 seconds, if the user presses on  the car that has to be stopped the game resumes and the user gets a score, else the game fails and a new view is displayed.\n"
				+"4. The game runs for a total of 300 seconds.\n"
				+"5. At the end of 300 seconds the game stops and displays a table which has information such\n" 
				 +"  a. Click count.\n"
				  +" b. Date of click.\n"
				   +"c. Time of click.\n"
	 ...
	 * @param listenForButton4 Information of the game
	 */
	...
	public void demoFunction()
	{
		...
		if(count<=3)
		{
			...
			JOptionPane.showMessageDialog(null, "Trial Has expierd please preceed to the real test!!! ", "DEMO", JOptionPane.INFORMATION_MESSAGE);
		}
	}
	 ...
	 * @param listenForButton5 Information of the game
	 */

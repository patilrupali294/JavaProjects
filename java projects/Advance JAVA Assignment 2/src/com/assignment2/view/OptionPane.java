...
public class OptionPane extends JFrame implements ActionListener {
	...
	/**
	 * This is the initial view It consists of options for the user to select
	 * the number of cars The color for cars Speed for each car
	 */
	...
	/**
	 * Action listener for START, RESET
	 */
	@Override
